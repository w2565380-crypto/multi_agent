  ...
  <div class="home-container">
    ...
    <div class="home-content">
      <div class="hero-section">
        ...
        <h1 class="hero-title">AI多智能体公司模拟系统</h1>
        <p class="hero-subtitle">多AI智能体实时协同 · 敏捷项目全流程模拟</p>
        <p class="hero-desc">
          模拟企业级 AI 产品经理、程序员、测试工程师<br>
          四大智能体协同工作，自动化任务流转与实时沟通
        </p>
...
.home-container {
  ...
  min-height: 100vh;
  background: linear-gradient(135deg, #0a0a1a 0%, #12122a 50%, #0d0d20 100%);
  position: relative;
  overflow: hidden;
}
