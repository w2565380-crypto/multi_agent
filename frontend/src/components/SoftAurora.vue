<template>
  <div ref="containerRef" class="soft-aurora-container" />
</template>
...
const props = defineProps({
  ...
  color1: { type: String, default: '#f7f7f7' },
  color2: { type: String, default: '#e100ff' },
  noiseFrequency: { type: Number, default: 2.5 },
  noiseAmplitude: { type: Number, default: 1.0 },
  bandHeight: { type: Number, default: 0.5 },
  bandSpread: { type: Number, default: 1.0 },
  octaveDecay: { type: Number, default: 0.1 },
  layerOffset: { type: Number, default: 0 },
  colorSpeed: { type: Number, default: 1.0 },
  enableMouseInteraction: { type: Boolean, default: true },
  mouseInfluence: { type: Number, default: 0.25 },
})
...
const updateUniforms = () => {
  ...
  program.uniforms.uNoiseFreq.value = props.noiseFrequency
  program.uniforms.uNoiseAmp.value = props.noiseAmplitude
  program.uniforms.uBandHeight.value = props.bandHeight
  program.uniforms.uBandSpread.value = props.bandSpread
  program.uniforms.uOctaveDecay.value = props.octaveDecay
  program.uniforms.uLayerOffset.value = props.layerOffset
  program.uniforms.uColorSpeed.value = props.colorSpeed
...
watch(() => [
  props.speed, props.scale, props.brightness,
  props.color1, props.color2, props.noiseFrequency,
  props.noiseAmplitude, props.bandHeight, props.bandSpread,
  props.octaveDecay, props.layerOffset, props.colorSpeed,
  props.enableMouseInteraction, props.mouseInfluence,
], updateUniforms)
</script>
